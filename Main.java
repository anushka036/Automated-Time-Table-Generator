...
public static void main(String[] args) throws IOException { 
    ...
    //hashmap to store batch, course, professors
    ...
    // String array to store timetable
    ...
    //Creating Buttons for delete functionality
    ...
    d4.addActionListener(new ActionListener(){
        public void actionPerformed(ActionEvent e){
            cb.removeItem(d3.getSelectedItem());
            cp4.removeItem(d3.getSelectedItem());
            cb4.removeItem(d3.getSelectedItem());
            JOptionPane.showMessageDialog(s,"Course "+d3.getSelectedItem()+" has been removed");
            d3.removeItem(d3.getSelectedItem());
            view.repaint();
        }
    });
    ...
    d8.addActionListener(new ActionListener(){
        public void actionPerformed(ActionEvent e){
            cb.removeItem(d7.getSelectedItem());
            cb7.removeItem(d7.getSelectedItem());
            JOptionPane.showMessageDialog(s,"Professor "+d7.getSelectedItem()+" has been removed");
            d7.removeItem(d7.getSelectedItem());
            view.repaint();
        }
    });
    ...
    d12.addActionListener(new ActionListener(){
        public void actionPerformed(ActionEvent e){
            cb.removeItem(d11.getSelectedItem());
            B.remove(d11.getSelectedItem());
            JOptionPane.showMessageDialog(s,"Batch "+d11.getSelectedItem()+" has been removed");
            d11.removeItem(d11.getSelectedItem());
            view.repaint();
        }
    });
